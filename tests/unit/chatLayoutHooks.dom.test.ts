...
vi.mock('@/renderer/utils/workspace/workspaceEvents', () => ({
  WORKSPACE_TOGGLE_EVENT: '1one-claudecode-workspace-toggle',
  WORKSPACE_STATE_EVENT: '1one-claudecode-workspace-state',
  WORKSPACE_HAS_FILES_EVENT: '1one-claudecode-workspace-has-files',
...
describe('useWorkspaceCollapse', () => {
  const STORAGE_KEY = '1one-claudecode_workspace_panel_collapsed';
