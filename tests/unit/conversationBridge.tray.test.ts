  ...
  vi.doMock('@/common', () => ({
    ipcBridge: {
      ...
      conversation: {
        ...
        prewarmCreate: createCommand('conversation.prewarmCreate'),
        prewarmClaim: createCommand('conversation.prewarmClaim'),
        finalizeFromPrewarm: createCommand('conversation.finalizeFromPrewarm'),
