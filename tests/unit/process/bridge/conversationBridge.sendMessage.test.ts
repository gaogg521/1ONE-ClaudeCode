...
vi.mock('@/common', () => ({
  ipcBridge: {
    ...
    conversation: {
      ...
      prewarmCreate: mockProvider('conversation.prewarmCreate'),
      prewarmClaim: mockProvider('conversation.prewarmClaim'),
      finalizeFromPrewarm: mockProvider('conversation.finalizeFromPrewarm'),
