...
- [✨ 功能概览](#-功能概览)
- [🖼️ 最新功能截图](#️-最新功能截图每张图含说明)
  - [统一入口总览](#1-统一入口总览)
  - [统一入口扩展视图](#2-统一入口扩展视图)
  - [多 Agent 管理](#3-多-agent-管理)
  - [模型管理](#4-模型管理)
  - [MCP 服务总览](#5-mcp-服务总览)
  - [MCP 一键添加](#6-mcp-一键添加)
  - [Hook 监控](#7-hook-监控)
  ...
  - [主题切换](#15-主题切换)
  - [工作空间](#16-工作空间)
  - [开机启动和多语言](#17-开机启动和多语言)
  - [助手与模型联动入口](#18-助手与模型联动入口)
- [🚀 快速开始](#-快速开始)
- [🛠️ 技术栈](#️-技术栈)
- [🤝 参与贡献](#-参与贡献)
- [📬 联系作者](#-联系作者)
...
<p align="center">
  <img src="./resources/统一入口.png" alt="统一入口总览" width="90%">
</p>

**图片说明：** 应用首页统一承载 Agent、模型、任务与扩展入口，日常操作可以在一个主界面完成。
...
**图片说明：** 展示统一入口的扩展信息区，强调多能力模块并列展示与快速切换。
...
**图片说明：** MCP 服务列表集中展示连接状态与可用工具，便于统一排查与运维。
...
**图片说明：** 通过可视化流程快速接入 MCP 服务，降低手动配置和排错成本。
...
**图片说明：** 将外部 IM 渠道接入工作流，实现消息通知、触发任务与结果回传。
...
<p align="center">
  <img src="./resources/一键添加各种使用MCP.png" alt="助手与模型联动入口" width="90%">
</p>
