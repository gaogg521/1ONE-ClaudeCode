...
export function createMainMenuCard(): LarkCard {
  return {
    ...
    header: {
      title: { tag: 'plain_text', content: '1ONE ClaudeCode Assistant' },
      template: 'blue',
    },
    elements: [
      {
    ...
    elements: [
      {
        ...
        content: [
          '**What is pairing?**',
          'Pairing links your Lark/Feishu account with the local 1ONE ClaudeCode application.',
...
export function createHelpCard(): LarkCard {
  return {
    config: { wide_screen_mode: true },
    header: {
      title: { tag: 'plain_text', content: '❓ 1ONE ClaudeCode Assistant Help' },
      template: 'turquoise',
    },
    elements: [
      {
        tag: 'markdown',
        content: [
          'A remote assistant to interact with 1ONE ClaudeCode via Lark.',
          '',
          '**Common Actions:**',
