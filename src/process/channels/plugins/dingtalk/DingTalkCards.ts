...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: '1ONE ClaudeCode Assistant',
    text: '### 1ONE ClaudeCode Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      '### Pairing Required',
      '',
      'Please pair your account with 1ONE ClaudeCode:',
      '',
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      '1. Open 1ONE ClaudeCode settings',
...
export function createPairingStatusCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      ...
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      'Please approve in 1ONE ClaudeCode settings:',
      '1. Open 1ONE ClaudeCode app',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: '1ONE ClaudeCode Assistant Help',
    text: [
      '### 1ONE ClaudeCode Assistant Help',
      '',
      'A remote assistant to interact with 1ONE ClaudeCode via DingTalk.',
      '',
      '**Common Actions:**',
...
export function createPairingGuideCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '3. Approve pairing in 1ONE ClaudeCode settings',
...
export function createSettingsCard(): DingTalkCard {
  return {
    ...
    text: [
      '### Settings',
      '',
      'Channel settings need to be configured in the 1ONE ClaudeCode app.',
      '',
      'Open 1ONE ClaudeCode > WebUI > Channels',
    ].join('\n'),
