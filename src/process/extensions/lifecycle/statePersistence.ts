 ...
 * Stored under getDataPath(): ~/.1ONE ClaudeCode/extension-states.json (Electron release),
 * ~/.1ONE ClaudeCode-dev/extension-states.json (Electron macOS dev), or the platform-standard
 * app data dir on Windows/Linux. Can be overridden via ONE_EXTENSION_STATES_FILE.
 */
