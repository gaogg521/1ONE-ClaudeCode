 ...
 *   - macOS:   ~/Library/Logs/1ONE ClaudeCode/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\1ONE ClaudeCode\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/1ONE ClaudeCode/logs/YYYY-MM-DD.log
 *
