...
// Override via ONE_CDP_PORT env variable. Set to "0" to disable.
//
...
// Registry file: ~/.1ONE ClaudeCode-cdp-registry.json
// ---------------------------------------------------------------------------

export const DEFAULT_CDP_PORT = 9230;
export const CDP_PORT_RANGE_START = 9230;
export const CDP_PORT_RANGE_END = 9250;
const CDP_REGISTRY_FILE = path.join(os.homedir(), '.1ONE ClaudeCode-cdp-registry.json');
...
function resolveCdpPortFromEnv(): number | null | undefined {
  const envVal = process.env.ONE_CDP_PORT;
