...
/**
 * Adapter class to convert ACP messages to 1ONE ClaudeCode message format
 */
export class AcpAdapter {
  ...
  /**
   * Convert ACP session update to 1ONE ClaudeCode messages
   */
  ...
  /**
   * Convert ACP session update chunk to 1ONE ClaudeCode message
   */
  ...
  /**
   * Convert ACP thought chunk to 1ONE ClaudeCode message
   */
  ...
  /**
   * Convert plan update to 1ONE ClaudeCode message
   */
