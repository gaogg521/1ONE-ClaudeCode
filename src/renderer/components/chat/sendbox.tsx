      ...
      >
        ...
        >
          ...
          <Input.TextArea
            ...
            className={`pl-0 pr-0 !b-none focus:shadow-none m-0 !bg-transparent !focus:bg-transparent !hover:bg-transparent lh-[20px] !resize-none text-13px ${isMobile ? 'sendbox-input--mobile' : ''}`}
            style={{
