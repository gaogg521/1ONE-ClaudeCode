...
/**
 * Warning component when OpenClaw channel conflicts with 1ONE ClaudeCode Channels
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not 1ONE ClaudeCode.</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in 1ONE ClaudeCode will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use 1ONE ClaudeCode Channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and 1ONE ClaudeCode.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for 1ONE ClaudeCode.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in 1ONE ClaudeCode Channels and continue using OpenClaw's integration.
          </Paragraph>
