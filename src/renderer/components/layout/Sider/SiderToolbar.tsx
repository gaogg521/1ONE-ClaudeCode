...
const SiderToolbar: React.FC<SiderToolbarProps> = ({
  ...
  return (
    <div className='mb-8px shrink-0 px-12px'>
      <Tooltip {...siderTooltipProps} content={t('conversation.welcome.newConversation')} position='right'>
        <div
          className={classNames(
            styles.newChatTrigger,
            'h-36px w-full flex items-center justify-start gap-8px px-10px rd-0.5rem cursor-pointer group transition-all bg-transparent text-t-primary hover:bg-fill-3 active:bg-fill-4',
