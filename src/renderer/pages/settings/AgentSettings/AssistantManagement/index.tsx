  ...
  return (
    <div>
      <AssistantListPanel
        ...
        onDelete={(assistant) => editor.handleDirectDeleteClick(assistant)}
      ...
      <DeleteAssistantModal
        ...
        onCancel={() => {
          editor.setDeleteConfirmVisible(false);
          editor.setPendingDeleteAssistant(null);
        }}
        onConfirm={editor.handleDeleteConfirm}
        activeAssistant={editor.pendingDeleteAssistant ?? activeAssistant}
        avatarImageMap={avatarImageMap}
      />
