...
const EnterpriseNavSidebar: React.FC<EnterpriseNavSidebarProps> = ({
  ...
  return (
    <aside
      ...
      style={{ background: 'var(--ep-bg-sidebar)', borderRight: '1px solid var(--ep-border-sidebar)' }}
    >
      <div className='px-16px pt-16px pb-12px border-b' style={{ borderBottomColor: 'var(--ep-border-divider)' }}>
        <div className='text-15px font-700 mb-4px' style={{ color: 'var(--ep-text-primary)' }}>
          {t('settings.enterpriseConsole.title', { defaultValue: '企业控制台' })}
        </div>
        <Typography.Paragraph
          type='secondary'
          className='mb-0 text-12px truncate'
