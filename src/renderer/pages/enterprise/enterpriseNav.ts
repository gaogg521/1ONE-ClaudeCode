...
> = {
  ...
  rag: { labelKey: 'settings.enterpriseConsole.navRagConfig', labelDefault: '知识库配置' },
  mcp: { labelKey: 'settings.enterpriseConsole.navMcpConfig', labelDefault: 'MCP 外部集成' },
  skills: { labelKey: 'settings.enterpriseConsole.navSkills', labelDefault: 'Skills 技能仓库' },
