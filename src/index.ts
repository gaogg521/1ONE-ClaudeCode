...
const createWindow = ({ showOnReady = true }: { showOnReady?: boolean } = {}): void => {
  ...
  const disableAutoUpdater =
    process.env.ONE_DISABLE_AUTO_UPDATE === '1' || process.env.ONE_E2E_TEST === '1' || isCiRuntime;
...
// Register 1ONE:// as the default protocol client
...
// macOS: handle 1ONE:// URLs via the open-url event
