...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  webuiSendResetCode: () => ipcRenderer.invoke('webui-direct-send-reset-code'),
  webuiResetPassword: (code: string) => ipcRenderer.invoke('webui-direct-reset-password', { code }),
  webuiSetAdminEmail: (email: string) => ipcRenderer.invoke('webui-direct-set-admin-email', { email }),
