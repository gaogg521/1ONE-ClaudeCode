...
import type { FfmpegDownloadProgress, FfmpegStatus } from '../types/mediaTools';
...
export interface IStartOnBootStatus {
  ...
  supported: boolean;
  /** Whether 1ONE is currently configured to launch at login */
  enabled: boolean;
...
export const fs = {
  ...
  // Skills Market: inject/remove the 1ONE-skills builtin skill
...
export const deepLink = {
  /** Emitted when app is opened via 1ONE:// protocol URL */
...
export const systemSettings = {
  ...
  getFfmpegStatus: bridge.buildProvider<FfmpegStatus, void>('system-settings:get-ffmpeg-status'),
  downloadFfmpeg: bridge.buildProvider<FfmpegStatus, void>('system-settings:download-ffmpeg'),
  ffmpegDownloadProgress: bridge.buildEmitter<FfmpegDownloadProgress>('system-settings:ffmpeg-download-progress'),
};
...
export const team = {
  ...
  sendMessage: bridge.buildProvider<void, { teamId: string; tenantId?: string; content: string; files?: string[] }>(
    'team.send-message'
  ),
