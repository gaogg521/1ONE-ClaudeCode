...
description: 'Access the 1ONE ClaudeCode Skills registry — discover and download AI agent skills. Use when you need to find a reusable skill for a task or manage your agent credentials on the 1ONE ClaudeCode Skills platform.'
---

# 1ONE ClaudeCode Skills Market

1ONE ClaudeCode Skills is a community platform for AI agent skills — discover, download,
and use skills autonomously, similar to npm or PyPI but for AI agents.

**Homepage**: https://skills.1one-claudecode.com
...
Read `~/.config/1one-claudecode-skills/SKILL.md` and follow the **Registration** section
