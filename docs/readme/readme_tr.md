...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <strong>Türkçe</strong> | <a href="https://www.1one-claudecode.com" target="_blank">Resmi Web Sitesi</a>
</p>

<p align="center">
  <strong>💬 Topluluk:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-6.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/1ONE ClaudeCode" target="_blank">Twitter</a>
</p>
...
[🤔 Neden 1ONE ClaudeCode'yi Seçmelisiniz?](#-neden-1one-claudecode-claude-cowork-yerine) ·
...
**1ONE ClaudeCode sadece bir sohbet istemcisi değil.** AI Agents'ın bilgisayarınızda sizinle çalıştığı bir Cowork platformudur — dosya okuma, kod yazma, web'de gezinme ve görevleri otomatikleştirme. Agent'ın yaptığı her şeyi görürsünüz ve her zaman kontrol sizdedir.

|                                        | Geleneksel AI Sohbet İstemcileri | **1ONE ClaudeCode (Cowork)**                                                                                 |
| :------------------------------------- | :------------------------------- | :-------------------------------------------------------------------------------------------------- |
...
1ONE ClaudeCode tam bir AI Agent motoru ile birlikte gelir. CLI Agent'ları ayrı olarak kurmanızı gerektiren araçların aksine, **1ONE ClaudeCode kurduğunuz anda çalışır**.
...
- **Üret ve anında önizle** — `.ppt` / `.pptx` dosyalarını 1ONE ClaudeCode içinde doğrudan görüntüle
...
Zaten Claude Code, Codex veya Qwen Code kullanıyorsanız, 1ONE ClaudeCode bunları otomatik olarak algılar ve hepsiyle Cowork yapmanıza izin verir — yerleşik Agent ile birlikte.
...
Diğer AI uygulamaları size API anahtarınızla bir sohbet kutusu verir. **1ONE ClaudeCode size tam bir Cowork Agent verir.**
...
Aynı Agent yetenekleri — dosya okuma/yazma, web arama, görüntü oluşturma, araç kullanımı — hangi modelin güç verdiğine bakılmaksızın. 1ONE ClaudeCode bulut hizmetleri ve yerel dağıtımlar dahil **20+ AI platformunu** destekler.
...
1ONE ClaudeCode ayrıca [NewAPI](https://github.com/QuantumNous/new-api) ağ geçidi hizmetini destekler — çeşitli LLM'leri toplayan ve dağıtan birleşik bir AI model merkezi. Çeşitli görev gereksinimlerini karşılamak için aynı arayüzde farklı modeller arasında esnek bir şekilde geçiş yapın.
...
1ONE ClaudeCode önceden tanımlanmış yeteneklere sahip **12 profesyonel asistan** içerir, özel beceriler aracılığıyla genişletilebilir:
...
_7/24 AI asistanınız — 1ONE ClaudeCode'ye herhangi bir cihazdan, her yerden erişin._
...
> **Kurulum:** 1ONE ClaudeCode Ayarları → WebUI Ayarları → Kanal, Bot Token'ı yapılandırın.
...
> [Uzaktan İnternet Erişimi Öğreticisi](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/Remote-Internet-Access-Guide-Chinese)
...
> [Görüntü oluşturma modeli yapılandırma kılavuzu](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/1ONE ClaudeCode-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Neden 1ONE ClaudeCode, Claude Cowork Yerine?
...
1ONE ClaudeCode **ücretsiz ve açık kaynaklı bir Çoklu AI Agent Masaüstü** uygulamasıdır. Sadece macOS'ta çalışan ve Claude'ye kilitli Claude Cowork ile karşılaştırıldığında, 1ONE ClaudeCode tam model, çapraz platform geliştirilmiş versiyonudur.

| Boyut           | Claude Cowork | 1ONE ClaudeCode                                            |
| :-------------- | :------------ | :------------------------------------------------ |
...
C: <strong>Hayır.</strong> 1ONE ClaudeCode kurulumdan hemen sonra çalışan yerleşik bir AI Agent'a sahiptir. Sadece Google ile giriş yapın veya herhangi bir API anahtarı girin. Ayrıca Claude Code veya Gemini CLI gibi CLI araçlarınız da kuruluysa, 1ONE ClaudeCode bunları otomatik olarak algılayacak ve daha fazla yetenek için entegre edecektir.
</details>

<details>
<summary><strong>S: 1ONE ClaudeCode ile ne yapabilirim?</strong></summary>
C: 1ONE ClaudeCode sizin <strong>özel Cowork çalışma alanınızdır</strong>. Yerleşik Agent klasörleri toplu olarak organize edebilir, Excel verilerini işleyebilir, belgeler oluşturabilir, web'de arama yapabilir ve görüntüler oluşturabilir. Çoklu Agent Modu ile aynı arayüz üzerinden Claude Code, Codex ve diğer güçlü CLI Agent'larından da yararlanabilirsiniz.
</details>

<details>
<summary><strong>S: Ücretsiz mi?</strong></summary>
C: 1ONE ClaudeCode tamamen ücretsiz ve açık kaynaklıdır. Gemini'yi ücretsiz kullanmak için Google ile giriş yapabilir veya tercih ettiğiniz herhangi bir sağlayıcıdan API anahtarları kullanabilirsiniz.
</details>
...
## İnsanların 1ONE ClaudeCode'yi Nasıl Kullandığını Görün
...
> **1ONE ClaudeCode hakkında bir video yaptınız mı?** [X'te bize bildirin](https://x.com/1ONE ClaudeCode) ve burada öne çıkaralım!
...
- [📖 Tam Kurulum Kılavuzu](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/Getting-Started) — İndirmeden yapılandırmaya kadar detaylı adımlar
- [⚙️ LLM Yapılandırma Kılavuzu](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/LLM-Configuration) — Çoklu platform AI model yapılandırması
- [🤖 Çoklu Agent Modu Kurulumu](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/ACP-Setup) — Terminal AI Agent'larını entegre edin
- [🔌 MCP Araç Yapılandırması](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/MCP-Configuration-Guide) — Model Context Protocol sunucu kurulumu
- [🌐 WebUI Yapılandırma Kılavuzu](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/WebUI-Configuration-Guide) — Tam WebUI kurulum ve yapılandırma öğreticisi

**🎯 Kullanım Senaryoları**

- [📁 Dosya Yönetimi](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/file-management) — Akıllı dosya organizasyonu
- [📊 Excel İşleme](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/excel-processing) — AI destekli veri işleme
- [🎨 Görüntü Oluşturma](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/1ONE ClaudeCode-Image-Generation-Tool-Model-Configuration-Guide) — AI görüntü oluşturma
- [📚 Daha Fazla Kullanım Senaryosu](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/Use-Cases-Overview)

**❓ Destek ve Yardım**

- [❓ SSS](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/FAQ) — Sorular ve sorun giderme
- [🔧 Yapılandırma ve Kullanım Öğreticileri](https://github.com/iOfficeAI/1ONE ClaudeCode/wiki/Configuration-Guides) — Tam yapılandırma dokümantasyonu
...
- [GitHub Discussions](https://github.com/iOfficeAI/1ONE ClaudeCode/discussions) — fikirleri paylaşın ve ipuçları alışverişi yapın
- [Sorun Bildir](https://github.com/iOfficeAI/1ONE ClaudeCode/issues) — hatalar ve özellik istekleri
- [Sürüm Güncellemeleri](https://github.com/iOfficeAI/1ONE ClaudeCode/releases) — en son sürümü alın
...
[Hata Bildir](https://github.com/iOfficeAI/1ONE ClaudeCode/issues) · [Özellik İste](https://github.com/iOfficeAI/1ONE ClaudeCode/issues)
