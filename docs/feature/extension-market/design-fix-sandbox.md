...
> PR：[#1991](https://github.com/iOfficeAI/1ONE ClaudeCode/pull/1991) (问题 1-3)
> Issue：[#1990](https://github.com/iOfficeAI/1ONE ClaudeCode/issues/1990)
...
JSON 文件 KV 存储，每个扩展一个文件 `~/.1one-claudecode/extension-storage/{name}.json`：
