...
1ONE ClaudeCode is an Electron app with three types of processes:
...
1ONE ClaudeCode can run in four modes. The WebSocket channel is the browser-side equivalent of
